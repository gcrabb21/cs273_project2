...
bool Address::operator==(Address other)
{
	...
	else if (postal != other.get_postal())
	{
		return false;
	}

	else if (email != other.get_email())
	{
		return false;
	}

	else if (street != other.get_street())
	{
		return false;
	}

	return true; //returns true if all values are determined to be equal.
}
